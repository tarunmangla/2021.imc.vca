...
be saturated by just two simultaneous 2-person Teams call, potentially leading to degradation in the end-user experience as will also be demonstrated in Section~\ref{sec:competition}}
\end{mdframed}
