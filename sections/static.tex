...
\begin{subfigure}
\centering
    \includegraphics[width=0.45\textwidth,keepaspectratio]{figures/static/downlink.pdf}
    \caption{Downlink bandwidth vs network bitrate}
	\label{subfig:downlink_bitrate}
\end{subfigure} \newline
\begin{subfigure}
    \centering
    \includegraphics[width=0.45\textwidth,keepaspectratio]{figures/static/uplink.pdf}
    \caption{Uplink bandwidth vs network bitrate}
	\label{subfig:uplink_bitrate}
\end{subfigure}
\caption{Utilization under fixed link capacities}
\label{fig:static}
\end{figure}
