...
Zoom and Meet both use under 1Mbps in both the downlink and uplink directions, 
while Teams uses 1.86/1.40Mbps. As available bandwidth is decerased. In addition,
VCA performance under the same network conditions varies among the three VCAs.}
\end{mdframed}
