...
>>>>>>> 46648a7c4247fea226933c4a1749eebbd5aedd6c
...
median sent network bitrate for different upstream capacities. We observe differences in upstream network
...
challenging for native clients. The Zoom API does provide limited
application performance (e.g., video resolution, FPS) at a per-minute
granularity~\cite{zoom_qos} for the native client, but this granularity is insufficient to
