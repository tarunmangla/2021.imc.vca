...
presence of a competing flow is most evident in Figure~\ref{fig:comp_netflix_zoom_teams}. 
...
a steady-state on-off regime. While Netflix takes longer to fill its buffer because 
