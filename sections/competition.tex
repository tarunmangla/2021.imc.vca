\begin{figure}[th]
    ...
    when competing with an incumbent Teams call on a 3 Mbps uplink capacity. Black
    trendline is competing applications. Note that the competing client's bitrate
...
\end{subfigure}
\caption{Upstream bitrate of VCAs in competition on a 0.5~Mbps capacity link. Black trendline is competing application. The competing client's bitrate drops to 0 Mbps because the connection is 
terminated.}
