...
\begin{figure*}
    ...
    \caption{VCA bitrates on a constrained upstream link, shared with other applications.  Figure labels (a-c) denote the incumbent application, whose bandwidth is plotted.}
    \label{fig:comp_ul}
\end{figure*}
