...
\end{enumerate}
\noindent
We answer these questions by a series of controlled experiments collecting VCA
performance data under a variety of network conditions and call modalities
(e.g., number of participants). The collected data show that the answers to
...
and where they can be found in the paper.
