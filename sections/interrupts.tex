...
=======
We also notice that Zoom's downstream and upstream bitrates remain at the level of available
capacity during the disruption; while, Meet and Teams suffer more
serious degradation. Zoom's efficient network utilization and response to
disruption could be due to its encoding mechanisms, wherein it can more
