...
\rev{}{especially in the last-mile.
...
\begin{figure}[]
   \centering
    ...
    If C1 is a VCA, it follows path (b). When C1 run iPerf3, it follows path (c), which is on the campus network, why there is no internet bubble.}}
